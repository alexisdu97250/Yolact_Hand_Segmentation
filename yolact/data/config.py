...
cocotrain2017_dataset = dataset_base.copy({
    'train_images': 'C:/libs/datasets/train2017',
    'valid_images': 'C:/libs/datasets/train2017',
    
    'train_info': 'C:/libs/datasets/train2017/annotations/instances_train2017.json',
    'valid_info': 'C:/libs/datasets/train2017/annotations/instances_val2017.json',
    'label_map': COCO_LABEL_MAP
    })
...
hands_2020_dataset = dataset_base.copy({
    'name': 'Hands_2020',

    'train_images': 'C:/libs/datasets/contours/data/images',
    'train_info':   'C:/libs/datasets/contours/annotations/annotations.json',

    'valid_images': 'C:/libs/datasets/contours/data/images',
    'valid_info':   'C:/libs/datasets/contours/annotations/annotations.json',

    'has_gt': True,
    'class_names': ("hand")
})

hands_labels_dataset = dataset_base.copy({
    'name': 'Hands_labels',

    'train_images': 'C:/libs/datasets/hand_labels/hand_labels/manual_train',
    'train_info':   'C:/libs/datasets/hand_labels/hand_labels/manual_train/annotations.json',

    'valid_images': 'C:/libs/datasets/hand_labels/hand_labels/manual_test',
    'valid_info':   'C:/libs/datasets/hand_labels/hand_labels/manual_test/annotations.json',
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': hands_2020_dataset,
    'num_classes': len(hands_2020_dataset.class_names) + 1,
